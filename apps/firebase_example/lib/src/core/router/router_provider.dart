...
import 'package:firebase_example/src/core/router/routes/route_location.dart';
import 'package:firebase_example/src/core/router/routes/route_name.dart';
...
Raw<GoRouter> router(Ref ref) {
  final GlobalKey<NavigatorState> navigatorKey =
      GlobalKey<NavigatorState>(debugLabel: 'Router');

  final AsyncValue<User?> authenticationState =
