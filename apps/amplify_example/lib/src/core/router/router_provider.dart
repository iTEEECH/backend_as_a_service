import 'package:amplify_example/src/core/router/routes/route_location.dart';
import 'package:amplify_example/src/core/router/routes/route_name.dart';
...
Raw<GoRouter> router(Ref ref) {
  ...
  final AsyncValue<AuthSession?> authenticationState = ref.watch(authenticationControllerProvider);
